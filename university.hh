...
public:
     ...
     * @brief is_course
     * @param course_name
     * @return true if course exists, false if doesn't.
     * Checks if the given course exists in the data base.
     */
    bool is_course(std::string course_name);

    /**
     * @brief is_account
     * @param account_number
     * @return true if account exists, false if doesn't.
     * Checks if the given account exists in the data base.
     */
    bool is_account(int account_number);
